...
const OrderHistory = () => {
  ...
  useEffect(() => {
    ...
    if (session_id) {
      axios
        .get(
          `https://corporate-zone-backend-main.vercel.app/order/success/${session_id}`
        )
  ...
  useEffect(() => {
    if (ready) {
      axios
        .put(
          `https://corporate-zone-backend-main.vercel.app/payment/${loggedInUser?.email}`,
          {
                ...
                <tbody>
                  {!payInfo ? (
                    <p className="text-base uppercase p-2">
                      ...
                      go{" "}
                      <Link href="/">
                        <a className="bg-blue-700 rounded-2xl text-white px-2">
                          home page
                        </a>
                      </Link>{" "}
                      to buy our plan.
